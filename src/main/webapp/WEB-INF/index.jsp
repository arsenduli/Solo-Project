                    ...
                    <div class="header-ctn">
                        ...
                        <div class="dropdown">
                            ...
                            <div class="cart-dropdown">
                                ...
                                <div class="cart-btns">
                                    <a href="#">View Cart</a>
                                    <a href="/checkout/${user.id}">Checkout  <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="${cate.urlCategori}" alt="">
                    </div>
                    <div class="shop-body">
                        <h3>${cate.name}<br>Collection</h3>
                        <a href="/categories/${cate.id}" class="cta-btn">Shop now <i class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            </c:forEach>
                    ...
                    <div class="products-tabs">
                        ...
                        <div id="tab1" class="tab-pane active">
                            <div class="products-slick" data-nav="#slick-nav-1">
                                <!-- product -->
                                <c:forEach items="${allProduct}" var="productsVar">
                                <div class="product">
                                    <div class="product-img">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-btns">
                                            ...
                                            <a href="/products/${productsVar.id}" class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp">quick view</span></a>
                                        </div>
                                        </c:if>
                                        <c:if test="${user == null}">
                                            <div class="product-btns">
        ...
        <div class="row">
            <div class="col-md-4 col-xs-6">
                ...
                <div class="products-widget-slick" data-nav="#slick-nav-3">
                    <div>
                        <c:forEach var="all" items="${allProducts}">
                            <!-- product widget -->
                            <div class="product-widget">
                                <div class="product-img">
                                    <img src="${all.url}" alt="">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-name"><a href="/products/${all.id}">${all.name}</a></h3>
                                    <h4 class="product-price">$${all.price}</h4>
                                </div>
                            </div>
                        </c:forEach>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                       ...
                       <c:forEach items="${allCategory}" var="fotter">
                        <ul class="footer-links">
                            <li><a href="/categories/${fotter.id}">${fotter.name}</a></li>
                        </ul>
                       </c:forEach>
                    </div>
                </div>
